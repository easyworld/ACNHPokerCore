...
namespace ACNHPokerCore
{
    partial class Freezer
    {
        ...
        private void InitializeComponent()
        {
            ...
            saveMapBtn.Text = "创建地图模板";
            formToolTip.SetToolTip(saveMapBtn, "创建一个地图模板并保存为 .nhf3 文件。（图层 1 和 2）\r\n");
            ...
            changeRateBtn.Text = "修改刷新延迟";
            formToolTip.SetToolTip(changeRateBtn, "修改刷新率。\r\n数字越小，刷新越频繁。\r\n为了减少负载，建议保持较高的数值。");
            ...
            startBtn.Tag = "Start";
            startBtn.Text = "开始";
            formToolTip.SetToolTip(startBtn, "开始重新生成时，仅忽略被选中的区域。\r\n[警告] 放置在选区外空白区域的物品将被删除。");
            ...
            unfreezeAllVillagerBtn.Text = "解锁所有村民";
            ...
            freezeAllVillagerBtn.Text = "锁定所有村民";
